...
function HomeIcon({ width = 512, height = 512, fillColor = "#33CCCC" }) {
  return (
    <svg
    ...
    >
      <g>
        ...
        <g>
          ...
          <g>
            <path d="M255.207,299.913c-24.13,0-43.761-19.631-43.761-43.761c2.404-58.055,85.127-58.037,87.522,0 C298.968,280.282,279.337,299.913,255.207,299.913z M255.207,234.392c-11.999,0-21.761,9.762-21.761,21.761 c1.195,28.869,42.331,28.86,43.522,0C276.968,244.153,267.206,234.392,255.207,234.392z" />
          </g>
        </g>
        <path
          style={{ fill: fillColor }}
