...
function PlanetIco({ width, height, color }) {
  return (
    <svg
      version="1.1"
      id="svg249"
    ...
    >
      <defs id="defs253">
        <clipPath clipPathUnits="userSpaceOnUse" id="clipPath263">
          <path d="M 0,512 H 512 V 0 H 0 Z" id="path261" />
        </clipPath>
      </defs>
      <g id="g255" transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)">
        <g id="g257">
          <g id="g259" clipPath="url(#clipPath263)">
            <g id="g265" transform="translate(176,426)">
              <path
            ...
            <g id="g269" transform="translate(414.7578,196)">
              <path
            ...
            <g id="g273" transform="translate(226,316)">
              <path
            ...
            <g id="g277" transform="translate(150.1836,96)">
              <path
            ...
            <g id="g281" transform="translate(403.5439,278)">
              <path
            ...
            <g id="g285" transform="translate(366,366)">
              <path
            ...
            <g id="g289" transform="translate(386,396)">
              <path
            ...
            <g id="g293" transform="translate(416,316)">
              <path
                d="m 0,0 c 0,-5.523 -4.478,-10 -10,-10 -5.522,0 -10,4.477 -10,10 0,5.523 4.478,10 10,10 C -4.478,10 0,5.523 0,0"
                style={{
                  fill: color,
            ...
            <g id="g297" transform="translate(371,326)">
              <path
            ...
            <g id="g301" transform="translate(456,356)">
              <path
            ...
            <g id="g305" transform="translate(62,156)">
              <path
            ...
            <g id="g309" transform="translate(490,246)">
              <path
                d="m 0,0 c 0,-11.046 -8.954,-20 -20,-20 -11.046,0 -20,8.954 -20,20 0,11.046 8.954,20 20,20 C -8.954,20 0,11.046 0,0 Z"
                style={{
                  fill: "none",
            ...
            <g id="g313" transform="translate(462,136)">
              <path
            ...
            <g id="g317" transform="translate(462,136)">
              <path
                d="M 0,0 C 0,-22.091 17.908,-40 40,-40"
                style={{
                  fill: "none",
            ...
            <g id="g321" transform="translate(462,56)">
              <path
                d="M 0,0 C 0,22.091 17.908,40 40,40"
                style={{
                  fill: "none",
            ...
            <g id="g325" transform="translate(462,56)">
              <path
                d="M 0,0 C 0,22.091 -17.908,40 -40,40"
                style={{
                  fill: "none",
            ...
            <g id="g329" transform="translate(50,376)">
              <path
            ...
            <g id="g333" transform="translate(50,376)">
              <path
                d="M 0,0 C 0,-22.091 17.909,-40 40,-40"
                style={{
                  fill: "none",
            ...
            <g id="g337" transform="translate(50,296)">
              <path
                d="M 0,0 C 0,22.091 17.909,40 40,40"
                style={{
                  fill: "none",
            ...
            <g id="g341" transform="translate(50,296)">
              <path
                d="M 0,0 C 0,22.091 -17.909,40 -40,40"
                style={{
                  fill: "none",
...
PlanetIco.defaultProps = {
  width: "100%",
  height: "100%",
  color: "#FFFFFF",
};

export default PlanetIco;
